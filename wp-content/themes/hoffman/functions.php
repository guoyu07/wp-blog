...
function hoffman_load_style() {
	if ( !is_admin() ) {
	    //wp_enqueue_style( 'hoffman_googleFonts', '//fonts.useso.com/css?family=Raleway:400,600,700,800|Vollkorn:400,400italic,700,700italic' );
...
function hoffman_add_editor_styles() {
    ...
    $font_url = '//fonts.useso.com/css?family=Raleway:400,600,700,800|Vollkorn:400,400italic,700,700italic';
